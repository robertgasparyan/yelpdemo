...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { Lastname: @administrator.Lastname, email: @administrator.email, name: @administrator.name, phonenumber: @administrator.phonenumber }
    end
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: { Lastname: @administrator.Lastname, email: @administrator.email, name: @administrator.name, phonenumber: @administrator.phonenumber }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
